...
public class Generator {
   ...
   private static void previewCreatedPerson() {
      System.out.println("##################### PREVIEW ####################");
      System.out.printf("\t\tPerson ID          :  %s\n", tempPersonId);
      System.out.printf("\t\tPerson Blood Type  :  %s\n", tempBloodType);
      System.out.printf("\t\tPerson is Donator  :  %s\n", tempIsDonator  ? "Yes" : "No");
      System.out.printf("\t\tPerson is Receiver :  %s\n", tempIsReceiver ? "Yes" : "No");
      System.out.printf("\t\tPerson is Disease  :  %s\n", tempIsDisease  ? "Yes" : "No");
      System.out.printf("\t\tUrgency            :  %s\n", tempIsUrgency  ? "Yes" : "No");
      System.out.println("###################################################");
   }
   ...
   public static Person generatePerson() throws IOException {
      ...
      if (!tempIsDonator) tempIsReceiver = true;
      else tempIsReceiver = false;
